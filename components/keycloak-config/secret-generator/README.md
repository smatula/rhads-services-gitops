# keycloak-config Secret Generator

This directory contains ArgoCD hooks to generate secrets and ConfigMaps for the keycloak-config deployment.
It creates the chicken realm with clients for TPA and TAS
